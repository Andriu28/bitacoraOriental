            ...
            <tr>
                <?php 
                    if (isset($data[0]['title'])) {
                        echo '<th>Título de Viaje</th>';
                    }
                    if (isset($data[0]['description'])) {
                        echo '<th>Descripción</th>';
                    }
                    if (isset($data[0]['numberTravel'])) {
                        echo '<th>Número Viajeros</th>';
                    }
        ...
        <tbody>
            <?php
                foreach ($data as $datas) {
                    ...
                    if (isset($datas['numberTravel'])) {
                        echo "<td>" . $datas['numberTravel'] . "</td>";
                    }    
