    ...
    <div class="contenedor-nuevo">
        <div class="caja-register">
            <div class="formulario-login-registro">
                <form id="formPubSpecial" edit="editData" action="index.php?controller=pubEspecial&action=edit&id=<?php echo $dataToView['data']['idPubSpecial']; ?>&idImage=<?php echo $dataToView['data']['idImage']; ?>" 
                ...
                <div class="btReset">
                    <div class="header">
                        ...
                        <h2>Editar publicación especial</h2>
                    </div>
                    ...
                    <div>
                        <label for="title">Título<span class="obligatorio">*</span> <span class="help-icon" data-tooltip="Modifique el título de la publicación especial.  &#10;Ejemplo: Oferta de verano"><?php echo HELP_ICON; ?></span></label>
                        <div class="errorMessage" id="errorMessagetitle"></div>
                        <input class="input-box" type="text" title="Ingrese un título" placeholder="Ingrese un título" id="title" name="title" maxlength="50" value="<?php echo $dataToView['data']['title']; ?>">

                        <label for="description">Descripción<span class="obligatorio">*</span> <span class="help-icon" data-tooltip="Modifique la descripción detallada de la publicación especial.  &#10;Ejemplo: 20% de descuento en todas las reservaciones de julio."><?php echo HELP_ICON; ?></span></label>
                        <div class="errorMessage" id="errorMessagedescription"></div>
                        <input class="input-box" type="text" title="Ingrese una descripción" placeholder="Ingrese una descripción" id="description" name="description" maxlength="300" value="<?php echo $dataToView['data']['description']; ?>">
                        ...
                        <a href="<?php echo $dataToView['data']['image']; ?>" target="_blank">
                            <img src="<?php echo $dataToView['data']['image']; ?>" width="100" height="100px">
                        </a>
