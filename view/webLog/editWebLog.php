...
<div class="contenedor-nuevo">
  <div class="caja-register">
    <div class="formulario-login-registro">
        ...
        <form id="formWebLog" edit="editData" action="index.php?controller=webLog&action=edit&id=<?php echo ($dataToView['data']['weblog']['idWebLog']); ?>" method="POST" enctype="multipart/form-data">
            <div class="btReset">
                <div class="header">
                ...
                <h2>Editar Bitácora de Viaje</h2>
                </div>
            ...
            <div class="form-section active" id="section1">
                ...
                <textarea class="input-box-bitacora" title="Ingrese una descripción" 
                        placeholder="Ingrese una descripción" id="description" name="description" ><?php echo $dataToView['data']['weblog']['description']; ?></textarea>
                        <!-- dejar esta etiqueta asi porque si no da espacios en el area de texto -->
                ...
                <input class="input-box" type="text" title="Ingrese un número de viaje" 
                       placeholder="Ingrese un número de viaje" id="numberTravel" name="numberTravel" maxlength="300"
                       value="<?php echo $dataToView['data']['weblog']['numberTravel']; ?>">
            ...
            <div class="form-section" id="section2">
                <?php require_once("EditWebLog2.php"); ?>
                <div class="text-grey">
                    <p>Todos los campos con<span class="obligatorio">*</span> son obligatorios</p>
                </div>
            ...
            <div class="form-section" id="section3">
                <?php require_once("EditWebLog3.php"); ?>
                <div class="text-grey">
                    <p>Todos los campos con<span class="obligatorio">*</span> son obligatorios</p>
                </div>
                <div class="buttom-container">
