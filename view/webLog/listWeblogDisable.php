        ...
        <div>
            <div class="header">
                <div class="titleModule">
                    ...
                    <h2>Bitácoras de Viaje Inhabilitadas</h2>
                </div>
                <div>
                    <a class="enlaces" href="index.php?controller=webLog&action=list" title="Visualizar Publicaciones habilitados"><button class="button-Rev2" >Habilitados</button></a>  
                </div>
            </div>
            <table id="webLogTable" class="display" style="width:100%">
                <thead>
                <tr>
                    ...
                    <?php foreach($dataToView["data"] as $data){ ?>
                        <tr>
                            ...
                            <td class="dataTable-icon-center">
                                ...
                                <a title="Habilitar" class="enable" href="index.php?controller=webLog&action=status&opc=enable&id=<?php echo $data['idWebLog'] ?>" title="Habilitar">
