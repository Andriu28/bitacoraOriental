    ...
    <div class="formulario-login-registro">
        <form id="formPackages" action="index.php?controller=packages&action=insert" method="POST" autocomplete="off">
            <div class="btReset">
                ...
                <input class="input-box" type="text" id="description" name="description" title="Ingrese una descripción" placeholder="Ingrese una descripción"><br>
                    ...
                    <div class="radio-box-space">
                        ...
                        <div class="radio-separation">
                            ...
                            <label for="transport_no">NO
                                <input class="radio-input" type="radio" id="transport_no" name="transport" value="NO" title="Transporte">
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="radio-box-space">
                        ...
                        <div class="radio-separation">
                            ...
                            <label for="food_no">NO
                                <input class="radio-input" type="radio" id="food_no" name="food" value="NO" title="Comida">
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="radio-box-space">
                        ...
                        <div class="radio-separation">
                            ...
                            <label for="lodging_no">NO
                                <input class="radio-input" type="radio" id="lodging_no" name="lodging" value="NO" title="Hospedaje">
                            </label>
                        </div>
                    </div>    
                </div>
                ...
                <div class="buttom-container">
                    ...
                    <a class="button-Rev" href="index.php?controller=packages&action=list" title="Cancelar">Cancelar</a>
                </div>
    </form>
