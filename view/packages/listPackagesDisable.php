        ...
        <div >
            <div class="header">
                <div class="titleModule">
                    ...
                    <h2>Paquetes de viaje Inhabilitados</h2>
                </div>
                <div>
                        ...
                        <tr>                            
                            ...
                            <td>
                                <div class="dataTable-icon-center">
                                    ...
                                    <a title="Habilitar" class="enable" href="index.php?controller=packages&action=status&opc=enable&id=<?php echo $data['idPackages'] ?>" title="habilitar">
