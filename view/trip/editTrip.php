...
<div class="contenedor-nuevo">
  <div class="caja-register">
    <div class="formulario-login-registro">
        ...
        <form id="trip" edit="editData" action="index.php?controller=trip&action=editTrip&id=<?php echo $dataToView['data']['idTrip']; ?>" method="POST" >
            <div class="btReset">
                <div class="header">
            ...
            <div class="form-section active" id="section1">                
                <div class="contenedor-formulario">
                    <div class="columna">
                        ...
                        <input class="input-box" type="text" id="title" name="title" title="Ingrese un título" maxlength="50" placeholder="Ingrese un título" value="<?php echo $dataToView['data']['title']; ?>">
                    </div>  
                    <div class="columna">
                        ...
                        <input class="input-box" type="text" id="departureLocation" name="departureLocation" title="Ingrese el lugar de salida" maxlength="100" placeholder="Ingrese el lugar de salida" value="<?php echo $dataToView['data']['departureLocation']; ?>">                        
                    </div>                                                  
                </div> 
                <div class="contenedor-formulario">
                    <div class="columna">
                        ...
                        <input class="input-box" type="date" id="departureDate" name="departureDate" title="Selecciona la fecha de salida" value="<?php echo $dataToView['data']['departureDate']; ?>">
                    </div>  
                    <div class="columna">
                        ...
                        <input class="input-box" type="time" id="departureTime" name="departureTime" title="Selecciona la hora de salida" value="<?php echo $dataToView['data']['departureTime']; ?>">
                    </div>                                                                       
                </div> 
                <div class="contenedor-formulario">
                    <div class="columna">
                        ...
                        <input class="input-box" type="date" id="returnDate" name="returnDate" title="Selecciona la fecha de regreso" value="<?php echo $dataToView['data']['returnDate']; ?>">                       
                        <input type="hidden" type="date" id="returnDateedit" name="returnDateedit" value="<?php echo $dataToView['data']['returnDate']; ?>">
                        <div class="errorMessage" id="errorMessagereturnDateedit"></div>
                    </div> 
                    <div class="columna">
                        ...
                        <input class="input-box" type="time" id="returnTime" name="returnTime" title="Selecciona la hora de regreso" value="<?php echo $dataToView['data']['returnTime']; ?>">                           
                    </div> 
                </div>    
                <div class="contenedor-formulario">
                    <div class="columna">
                        ...
                        <input class="input-box" type="text" id="numberSlots" name="numberSlots" title="Ingrese la cantidad de cupos" maxlength="11" placeholder="Ingrese la cantidad de cupos" value="<?php echo $dataToView['data']['numberSlots']; ?>">
                        <input type="hidden" id="cuposantes" name="cuposantes" value="<?php echo $dataToView['data']['numberSlots']; ?>">
                        <input type="hidden" id="vacant" name="vacant" value="<?php echo $dataToView['data']['vacant']; ?>">
                    </div>                             
                    <div class="columna">
                        ...
                        <input class="input-box" type="text" id="price" name="price" title="Ingrese el costo del viaje" maxlength="11" placeholder="Ingrese el costo del viaje" value="<?php echo $dataToView['data']['price']; ?>">
                    </div>                                                                                      
                </div>        
                
                <div class="columna" id="section2">                                                    
            ...
            <div  class="form-section" id="section2">
                <?php 
                require_once("view/trip/editTrip3.php");
                ?>
                <div class="buttom-container">
                    <button class="button-ant-sig" type="button" onclick="previousSection()">Anterior</button>
                </div>
