    ...
    <div>
      <div class="header">
        <div class="titleModule">
          ...
          <h2>Ofertas de viaje canceladas</h2>
        </div>
        <div>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="dataTable-icon-center">
                    ...
                    <a class="rehacer" title="Inhabilitar" href="index.php?controller=trip&action=disableTrip&id=<?php echo $data['idTrip'];?>&opc=H" title="Habilitar">
