    ...
    <div>
      <div class="header">
        ...
        <?php  if( isset($_SESSION['privilege']) && $_SESSION['privilege'] == 'admin' &&count($dataToView["data"]) > 0 ){ ?>
                    ...
                    <?php  } ?>
          <a class="enlaces" href="index.php?controller=trip&action=addTrip" title="Añadir">
            <button class="button-Rev2">Añadir</button>
          </a>
          <a class="enlaces" href="index.php?controller=trip&action=listTripDisabled" title="Ofertas de viajes canceladas">
            <button class="button-Rev2">Canceladas</button>
          </a>
          <a class="enlaces" href="index.php?controller=trip&action=listTripRealiz" title="Ofertas de viajes realizados">
            <button class="button-Rev2">Realizadas</button>
          </a>
          ...
          <tbody>
            ...
            <tr>
              ...
              <div class="dataTable-icon-center">
                ...
                <a  title="Editar" href="index.php?controller=trip&action=editTrip&id=<?php echo $data['idTrip']; ?>&idpack=<?php echo $data['idPackages']; ?>" >
                    <?php echo EDIT_ICON ?>   
                </a>
                <a class="cancel" title="Inhabilitar" href="index.php?controller=trip&action=disableTrip&id=<?php echo $data['idTrip'];?>&opc=I" >
