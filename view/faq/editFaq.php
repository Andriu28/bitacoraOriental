    ...
    <div class="contenedor-nuevo">
        <div class="caja-register">
            <div class="formulario-login-registro">
				<form id="faq" edit="editData" action="index.php?controller=faqs&action=editFaq&id=<?php echo $dataToView["data"]->id_preg_frecuente; ?>" method="POST">
				...
				<!-- Mostrar la pregunta actual -->
					<label for="query">Pregunta<span class="obligatorio">*</span> <span class="help-icon" data-tooltip="Modifique la pregunta frecuente. &#10;Ejemplo: ¿Cómo puedo restablecer mi contraseña?"><?php echo HELP_ICON; ?></span></label>
					<div class="errorMessage" id="errorMessagequery"></div>
					<input class="input-box" type="text" name="query" id="query" maxlength="100"
						title="Ingrese una pregunta frecuente" placeholder="Ingrese una pregunta frecuente" value="<?php echo $dataToView['data']->query; ?>" />

					<!-- Mostrar la respuesta actual -->
					<label for="respond">Respuesta<span class="obligatorio">*</span> <span class="help-icon" data-tooltip="Modifique la respuesta a la pregunta frecuente.  &#10;Ejemplo: Para restablecer su contraseña, haga clic en 'Olvidé mi contraseña'  &#10;y siga las instrucciones."><?php echo HELP_ICON; ?></span></label>
					<div class="errorMessage" id="errorMessagerespond"></div>
					<input class="input-box" type="text" name="respond" id="respond" maxlength="250"
						title="Ingrese la respuesta" placeholder="Ingrese la respuesta" value="<?php echo $dataToView['data']->respond; ?>">
					...
					<div class="buttom-container">
						<button class="button-login-register" type="submit" title="Editar">Editar</button>
