        ...
        <div>
            <div class="header">
                <div class="titleModule">
                    ...
                    <h2>Preguntas frecuentes inhabilitadas</h2>
                </div>
                                ...
                                <td>
                                    ...
                                    <td>
                                        <div class="dataTable-icon-center">
                                            ...
                                            <a title="Habilitar" class="enable" href="index.php?controller=faqs&action=status&opc=enable&id=<?php echo $data->id_preg_frecuente;?> ?>" title="habilitar">
